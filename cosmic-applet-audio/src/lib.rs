...
impl cosmic::Application for Audio {
    ...
    fn view(&self) -> Element<'_, Message> {
        ...
        let btn = crate::mouse_area::MouseArea::new(btn).on_mouse_wheel(|delta| {
            ...
            let new_volume = (self.model.sink_volume as f64 + (scroll_vector as f64)).clamp(
                0.0,
            ...
            Message::SinkVolumeChanged(new_volume as u32)
        });
    ...
    fn view_window(&self, _id: window::Id) -> Element<'_, Message> {
        ...
        let mut audio_content = {
            let output_slider = if self.output_amplification {
                slider(0..=150, self.model.sink_volume, Message::SinkVolumeChanged)
                    .width(Length::FillPortion(5))
                    .breakpoints(&[100])
            } else {
                slider(0..=100, self.model.sink_volume, Message::SinkVolumeChanged)
                    .width(Length::FillPortion(5))
            };
