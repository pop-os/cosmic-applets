...
use cosmic::{
    ...
    theme,
    widget::{autosize::autosize, button, divider, horizontal_space, icon, text, Column, Id, Row},
...
impl cosmic::Application for Audio {
    ...
    fn view_window(&self, _id: window::Id) -> Element<Message> {
        ...
        autosize(
            self.core.applet.popup_container(container(content)),
            AUTOSIZE_MAIN_ID.clone(),
        )
        .limits(Limits::NONE.width(400.))
        .into()
    }
